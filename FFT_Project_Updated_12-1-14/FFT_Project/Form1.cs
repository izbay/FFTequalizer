    ...
    public partial class Form1 : Form
    {
        ...
        private void loadWaveFile(object sender, EventArgs e)
        {
            ...
            if (openedFile.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    aTimer = new System.Timers.Timer(46.4);
        ...
        void OnTimed(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                counter += 138;//350; // Skip ahead so we're not sampling concentrated areas repeatedly.
            }
        ...
        private void doFFT(double[] data)
        {
            ...
            for (int i = 0; i < data.Length-1; i += 2)
            {
                ...
                chart1.Series["Series1"].Points.AddXY(i + 1, (Math.Sqrt(data[i]*data[i]+data[i+1]*data[i+1])));
            }
